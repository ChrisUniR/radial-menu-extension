...
function takeScreenshot (selectionLeft, selectionTop, selectionWidth, selectionHeight) {
  chrome.runtime.sendMessage({name: 'screenshot'}, function(response) {
      ...
      img.onload = function() {
        ...
        let windowHeight = window.innerHeight;
          ...
          renderImage(canvas, selectionLeft, selectionTop, selectionWidth, selectionHeight);
      }      
  });
}
